...
## What is implemented (0.10.0-alpha.11)
...
Not implemented, deliberately: any send path; model-backed situation classification; embedding-backed retrieval; learning that alters a measured metric; any single accuracy figure or headline score in the UI (the measurement shows its measures apart); IMAP OAuth; TRUSTED mode. See `docs/PROJECT_STATUS.md` for the row-by-row picture and `docs/ROADMAP.md` for where each lands.
