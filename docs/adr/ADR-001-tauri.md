...
**Context**: Windows-first desktop app, needs native file dialogs, a child process, a loopback server, a signed updater from GitHub Releases, and small footprint.
